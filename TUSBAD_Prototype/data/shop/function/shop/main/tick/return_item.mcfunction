...
# カーソルにあったらそこに戻して終了
$execute store success storage shop: test byte 1 if items entity @p[tag=Opener] player.cursor *[custom_data={none:0}] run item replace entity @s player.cursor from entity @s container.$(slot)
